  ...
  return (
    <div className="pt-28 pb-24">
      <Container>
        <SectionHeader
          eyebrow="Resources"
          title="Guides for healthcare leaders and technical teams"
          description="Practical content on unifying data, measuring what matters, and implementing the intelligence layer."
        />
